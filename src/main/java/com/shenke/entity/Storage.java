...
public class Storage {
	...
	public String toString() {
		return "Storage [id=" + id + ", saleListProduct=" + saleListProduct + ", jitaiProductionAllot="
				+ jitaiProductionAllot + ", jiTai=" + jiTai + ", saleList=" + saleList + ", name=" + name + ", model="
				+ model + ", price=" + price + ", length=" + length + ", color=" + color + ", realitymodel="
				+ realitymodel + ", realityprice=" + realityprice + ", realityweight=" + realityweight + ", num=" + num
				...
				+ issueState + ", accomplishState=" + accomplishState + ", dateInProduced=" + dateInProduced
				+ ", remark=" + remark + "]";
	}
